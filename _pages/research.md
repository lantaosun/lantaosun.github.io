...
<div style="display: flex; align-items: flex-start; margin-bottom: 20px;">
  ...
  <div style="flex: 1; padding-right: 20px;">
    <img src="01_PAMIP.jpg" alt="Polar-amplification-Model-Intercomparison Project (PAMIP)" style="width: 150px; height: auto;">
  </div>
  <!-- Right: Text -->
  <div style="flex: 2;">
    ...
    <ul>
      <li>What caused the observed “Warm Arctic, Cold Continents” trend pattern in winter temperatures? What are the roles of sea ice concentration anomaly and ice thinning for the Arctic warming?</li>
